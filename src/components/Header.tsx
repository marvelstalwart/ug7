...
useEffect(()=> {
  ...
  return (
    <div className={`w-full px-[16px] md:px-[34px] lg:px-[64px] py-[24px]  bg-neutral-700   h-fit fixed ${isHidden? '-translate-y-16' : 'translate-y-0'} top-16 transition-all duration-100 z-40`}>
